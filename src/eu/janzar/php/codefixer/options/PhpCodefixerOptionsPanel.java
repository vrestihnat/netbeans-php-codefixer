 ...
 * @author junichi11
 */
public class PhpCodefixerOptionsPanel extends javax.swing.JPanel {
     ...
     */
    public PhpCodefixerOptionsPanel() {
        initComponents();
        init();
    }
  ...
  private void initComponents() {
    ...
    Mnemonics.setLocalizedText(levelCheckBox, NbBundle.getMessage(PhpCodefixerOptionsPanel.class, "PhpCodefixerOptionsPanel.levelCheckBox.text")); // NOI18N

    levelComboBox.setModel(new DefaultComboBoxModel<String>(new String[] { "", "psr0", "psr1", "psr2", "symfony"}));

    Mnemonics.setLocalizedText(configCheckBox, NbBundle.getMessage(PhpCodefixerOptionsPanel.class, "PhpCodefixerOptionsPanel.configCheckBox.text")); // NOI18N

    configComboBox.setEditable(true);
    configComboBox.setModel(new DefaultComboBoxModel<String>(new String[] { "", "default", "magento", "sf23"}));

    Mnemonics.setLocalizedText(fixersCheckBox, NbBundle.getMessage(PhpCodefixerOptionsPanel.class, "PhpCodefixerOptionsPanel.fixersCheckBox.text")); // NOI18N

    fixersTextField.setText(NbBundle.getMessage(PhpCodefixerOptionsPanel.class, "PhpCodefixerOptionsPanel.fixersTextField.text")); // NOI18N

    Mnemonics.setLocalizedText(customCheckBox, NbBundle.getMessage(PhpCodefixerOptionsPanel.class, "PhpCodefixerOptionsPanel.customCheckBox.text")); // NOI18N

    customTextField.setText(NbBundle.getMessage(PhpCodefixerOptionsPanel.class, "PhpCodefixerOptionsPanel.customTextField.text")); // NOI18N

    Mnemonics.setLocalizedText(runOnSaveCheckBox, NbBundle.getMessage(PhpCodefixerOptionsPanel.class, "PhpCodefixerOptionsPanel.runOnSaveCheckBox.text")); // NOI18N

    Mnemonics.setLocalizedText(dryRunLabel, NbBundle.getMessage(PhpCodefixerOptionsPanel.class, "PhpCodefixerOptionsPanel.dryRunLabel.text")); // NOI18N

    Mnemonics.setLocalizedText(verboseCheckBox, NbBundle.getMessage(PhpCodefixerOptionsPanel.class, "PhpCodefixerOptionsPanel.verboseCheckBox.text")); // NOI18N

    Mnemonics.setLocalizedText(diffCheckBox, NbBundle.getMessage(PhpCodefixerOptionsPanel.class, "PhpCodefixerOptionsPanel.diffCheckBox.text")); // NOI18N

    Mnemonics.setLocalizedText(versionLabel, NbBundle.getMessage(PhpCodefixerOptionsPanel.class, "PhpCodefixerOptionsPanel.versionLabel.text")); // NOI18N
    ...
    Mnemonics.setLocalizedText(rulesCheckBox, NbBundle.getMessage(PhpCodefixerOptionsPanel.class, "PhpCodefixerOptionsPanel.rulesCheckBox.text")); // NOI18N

    rulesTextField.setText(NbBundle.getMessage(PhpCodefixerOptionsPanel.class, "PhpCodefixerOptionsPanel.rulesTextField.text")); // NOI18N

    Mnemonics.setLocalizedText(diffFormatUdiffCheckBox, NbBundle.getMessage(PhpCodefixerOptionsPanel.class, "PhpCodefixerOptionsPanel.diffFormatUdiffCheckBox.text")); // NOI18N
